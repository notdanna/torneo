...
import { useTorneoCompleto } from '../../../../core/hooks/futbolitoGrupos/useTorneoCompleto_2';
...
export const TorneoContainer12: React.FC<TorneoContainerProps> = ({ className = "" }) => {
        ...
        <div className="flex flex-col items-center justify-center w-full">
          <h2 className="w-full flex justify-center items-center text-xl font-bold text-green-700 drop-shadow-md gap-2">
            ...
            <span className="bg-gradient-to-r from-green-200 via-green-100 to-green-200 px-4 py-1 rounded-lg shadow-md border border-green-300">
              Futbolito : <span className="font-extrabold text-green-800">GRUPO 2</span>
            </span>
            <span className="text-2xl">🏆</span>
          </h2>
...
export default TorneoContainer12;