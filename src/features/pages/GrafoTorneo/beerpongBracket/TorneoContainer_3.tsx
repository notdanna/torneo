...
import { useTorneoCompleto } from '../../../../core/hooks/beerpongGrupos/useTorneoCompleto_3';
...
export const TorneoContainer33: React.FC<TorneoContainerProps> = ({ className = "" }) => {
...
export default TorneoContainer33;